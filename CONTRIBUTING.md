...
Thank you for considering contributing to [auth](https://github.com/xsy420/auth)!

When contributing, please first discuss the change you wish to make via [issue](https://github.com/xsy420/auth/issues),
...
```sh
git clone https://github.com/{username}/auth && cd auth
# OR
git clone git@github.com:{username}/auth && cd auth
```

To ensure the successful execution of the tests, it is essential to fetch the tags as follows:

```sh
git fetch --tags https://github.com/xsy420/auth
```
...
By contributing, you agree that your contributions will be licensed under [GPL-2.0](./LICENSE).
